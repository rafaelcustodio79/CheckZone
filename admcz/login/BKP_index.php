  ...
  <![endif]-->
    ...
    var onloadCallback = function() {
        grecaptcha.render('html_element', {
            'sitekey': '6LcrmuoqAAAAAEmYiQMenguDSYKrgg5yIAm5lTxb',
            'size': 'normal' // Você pode usar 'normal' ou 'compact' aqui
        });
    };
    </script>
    ...
    /* Estilo para links dentro de qualquer elemento com a classe .link-especial */
    .link-especial a {
        color: #0b298c;
        text-decoration: none;
    }

    /* Estilo para o link quando passar o mouse */
    ...
    <div class="row" style="padding-top: 30px;">
        <div class="col-lg-2 text-center">
            <div class="login-logo">
                <a href="../index.php"><img src="../img/logo_completa.png" style="max-height: 300px;"></a>
            </div>
            <!-- /.login-logo -->
        </div>
                    ...
                    <form name="acesso" action="verifica-usuario.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 text-center">
                                <button type="submit" class="btn btn-entrar" style="color: 171c5a;"><i
                                        class="fas fa-sign-in-alt"></i> Acessar</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
