  ...
  <![endif]-->
    ...
    <style type="text/css">
        .fundo-pagina {
            ...
            height: 100vh;
            z-index: -1;
            background-image: url('../assets/img/fundo_login.jpg');
...
<body class="hold-transition login-page">
    ...
    <div class="row" style="padding-top: 30px;">
        <div class="col-lg-6 text-left">
            <div class="login-logo">
                <a href="../index.php"><img src="../assets/img/logos/sistema/logo-logix.png" style="max-width: 300px;"></a>
            </div>
            <!-- /.login-logo -->
        </div>
        <div class="col-lg-6 text-right" style="padding-top: 20px;padding-right:50px;">
            Não tem uma conta? <button type="button" class="btn btn-warning" onclick="abrirRegistrar();"><i class="fa fa-user-plus" aria-hidden="true"></i> Marque uma DEMO</button>
        </div>
    </div>
    <div class="login-box" style="width:420px;border-radius: 10px;background-color:#eceff4;padding:30px;">
        <div>
            <h3 class="login-box-msg" style="color:#171c5a;">Bem vindo a Logixflash</h3>
    ...
    <!-- /.login-box -->
    <p style="text-align:center;color:#fff;padding-top:20px;">Não tem conta? <a href="../registrar/" style="color: #5773a2;">Marque uma DEMO</a></p>
