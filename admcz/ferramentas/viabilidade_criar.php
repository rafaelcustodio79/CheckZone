...
if ($visualizar==null) {
    ...
    $passo = isset($_SESSION['passo']) ? $_SESSION['passo'] : 1;
}
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">Ferrsmentas</li>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12" style="padding-left: 20px;">
            <span class="badge badge-info" style="background-color: #046868;">Estudo: </span>
            <h4>
                <b><?=$dados['nome_estudo'];?></b>
            </h4>
            </span>
        </div>
    </div>
            ...
            <div class="card card-info card-tabs">
                <div class="card-header p-0 pt-1">
                    <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                        <li class="pt-2 px-3">
                            <h3 class="card-title">Etapas dos estudo</h3>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $passo == 1 ? 'active' : '' ?>" id="dados-iniciais"
                                data-toggle="pill" href="#custom-tabs-two-dados-iniciais" role="tab"
                                aria-controls="custom-tabs-two-dados-iniciais" aria-selected="true">1 - Dados
                                iniciais</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $passo == 2 ? 'active' : '' ?>" id="produto" data-toggle="pill"
                                href="#custom-tabs-two-produto" role="tab" aria-controls="custom-tabs-two-produto"
                                aria-selected="false">2 -
                                Produto(s)</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $passo == 3 ? 'active' : '' ?>" id="mercadoria" data-toggle="pill"
                                href="#custom-tabs-two-mercadoria" role="tab" aria-controls="custom-tabs-two-mercadoria"
                                aria-selected="false">3 -
                                Mercadoria</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $passo == 4 ? 'active' : '' ?>" id="valores-li" data-toggle="pill"
                                href="#custom-tabs-two-valores-li" role="tab" aria-controls="custom-tabs-two-valores-li"
                                aria-selected="false">4 - Logística Internacional</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $passo == 5 ? 'active' : '' ?>" id="valores-da" data-toggle="pill"
                                href="#custom-tabs-two-valores-da" role="tab" aria-controls="custom-tabs-two-valores-da"
                                aria-selected="false">5 - Despesas
                                aduaneiras</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $passo == 6 ? 'active' : '' ?>" id="calculo" data-toggle="pill"
                                href="#custom-tabs-two-calculo" role="tab" aria-controls="custom-tabs-two-calculo"
                                aria-selected="false">Finalizar</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-two-tabContent">
                        ...
                        <div class="tab-pane fade <?= $passo == 1 ? 'show active' : '' ?>"
                            id="custom-tabs-two-dados-iniciais" role="tabpanel" aria-labelledby="dados-iniciais">


                            <?php if (empty($dados['origem']) || $editar_1 == 1): ?>

                            <form name="ii-pv" action="ferramentas/grava_pv_info_iniciais.php" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="box-body">
                                            ...
                                            <select class="form-control" name="moeda_padrao" style="width: 100%;"
                                                required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="box-body">
                                            ...
                                            <br clear="all">
                                            <input type="number" class="form-control" id="qtConteiner"
                                                name="qtConteiner" disabled>
                                        </div>
                                        <!-- /.box-body -->
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-right">
                                        <div class="box-body">
                                            ...
                                            <a href="ferramentas/editar_pv_cancelar.php?visualizar=1&idEstudo=<?=$idEstudo;?>"
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-right">
                                    <div class="box-body">
                                        <br clear="all">
                                        <a href="ferramentas/editar_pv_1.php?visualizar=1&idEstudo=<?=$idEstudo;?>"
                        ...
                        <div class="tab-pane fade <?= $passo == 2 ? 'show active' : '' ?>" id="custom-tabs-two-produto"
                            role="tabpanel" aria-labelledby="produto">
                                ...
                                <table id="listaProd" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="ferramentas/deletar_pv_produto.php?idProd=<?=$resultado['id'];?>&idPV=<?=$idEstudo;?>"
                                                    onclick="return confirm('Deseja realmente excluir o Produto?')"><i
                                                        class="fa fa-trash" title="Remover"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-right">
                                    <div class="box-body">
                                        <br clear="all">
                                        <a href="ferramentas/salvar_pv_produtos.php?idPV=<?=$idEstudo;?>"
                                            class="btn btn-primary">
                                            <i class="fas fa-save" title="Salvar"></i> Salvar
                                        </a>
                        ...
                        <div class="tab-pane fade <?= $passo == 3 ? 'show active' : '' ?>"
                            id="custom-tabs-two-mercadoria" role="tabpanel" aria-labelledby="mercadoria">
                            ...
                            <form name="ii-pv" action="ferramentas/grava_pv_info_mercadorias.php" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-right">
                                        <div class="box-body">
                                            <br clear="all">
                                            <a href="ferramentas/editar_pv_3.php?visualizar=1&idEstudo=<?=$idEstudo;?>"
                                                class="btn btn-warning">
                                                <i class="fa fa-edit"></i> Editar
                                            </a>
                                        </div>
                        ...
                        <div class="tab-pane fade <?= $passo == 4 ? 'show active' : '' ?>"
                            id="custom-tabs-two-valores-li" role="tabpanel" aria-labelledby="valores-li">

                            <?php if (is_null($dados['valor_log_int']) || $editar_4 == 1): ?>

                            <form name="li-pv" action="ferramentas/grava_pv_vli.php" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="box-body">
                                            ...
                                            <input type="text" class="form-control" name="taxas" id="valorTotalTaxas"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="box-body">
                                            ...
                                            <input type="text" class="form-control" name="seguro" id="valorTotalSeguro"
                                                required>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-right">
                                    <div class="box-body">
                                        <br clear="all">
                                        <a href="ferramentas/editar_pv_4.php?visualizar=1&idEstudo=<?=$idEstudo;?>"
                                            class="btn btn-warning">
                                            <i class="fa fa-edit"></i> Editar
                                        </a>
                                    </div>
                        ...
                        <div class="tab-pane fade <?= $passo == 5 ? 'show active' : '' ?>"
                            id="custom-tabs-two-valores-da" role="tabpanel" aria-labelledby="valores-da">

                            <?php if (is_null($dados['valor_armazenagem']) || $dados['valor_armazenagem'] == '0.00' || $editar_5 == 1): ?>

                            <form name="da-pv" action="ferramentas/grava_pv_da.php" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="box-body">
                                            <label>Frete Nacional (opcional) | R$</label><br><br>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="box-body">
                                            <label>Outras despesas | R$</label><br><br>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="box-body">
                                            <label>Licença de Importação (opcional) | R$</label><br><br>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="box-body">
                                            <label>Anuência de Importação (opcional) | R$</label><br><br>
                    ...
                    <div class="tab-pane fade <?= $passo == 6 ? 'show active' : '' ?>" id="custom-tabs-two-calculo"
                        role="tabpanel" aria-labelledby="calculo">
                        <div class="row">
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-secondary">
            ...
            <div class="modal-body">
                ...
                <form role="form" name="cadastro-usuario-ferramentas" method="post"
                    action="ferramentas/calcula_armazenagem_a_da.php">
                        ...
                        <div class="col-lg-12">
                            <div class="box-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="valorCif2" class="form-control"
                ...
                <!-- form start -->
                <form role="form" name="cadastro-usuario-ferramentas" method="post"
                    action="ferramentas/calcula_armazenagem_m_da.php">
