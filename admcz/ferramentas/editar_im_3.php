...
if ($idIM) {
    ...
    try {
        ...
        header('Location: ../cliente.php?pg=invoice_maker_editar&idIM='.$idIM.'&invoice='.$invoice_number.'&flag=success&tip=Importador alterado com sucesso!&tabAtiva=2');
        exit();
    } catch (PDOException $e) {
        // Redirecionamento em caso de erro
        header('Location: ../cliente.php?pg=invoice_maker_editar&idIM='.$idIM.'&invoice='.$invoice_number.'&flag=erro&tip=Não foi possível realizar a operação. '.$e->getMessage());
    }
} else {
