...
try {
    ...
    $dados[] = $nomeAeroporto;
    $dados[] = "Data de Entrada: " . $dataInicial;
    $dados[] = "Data de Cálculo: " . $dataFinal;
    $dados[] = "Período Total: " . $numDias . " dia(s)";
    $dados[] = "R$ " . $cif;
    $dados[] = $peso_bruto . " Kg";
    $dados[] = "R$ " . number_format($valorTotalArmazenagem, 2, ',', '.');
    $dados[] = "R$ " . number_format($valorCapatazia, 2, ',', '.');
    $dados[] = "R$ " . number_format($valorTotalArmazenagem + $valorCapatazia, 2, ',', '.');

    // Armazenar os dados na sessão
    $_SESSION['dados'] = $dados;

    // Redirecionar para outra página
    header("Location: ../ferramentas.php?a=ferramentas&b=formulario_armazenagem_a");
    exit();
