                        ...
                        <div class="bs-stepper-content">
                                ...
                                <form id="invoice-details" name="invoice-details" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group text-right">
                                            <button class="btn btn-primary" type="submit"><i class="fa fa-floppy-o"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <button type="button" class="btn btn-info" data-toggle="modal"
                                                ...
                                                <i class="fa fa-plus"></i> Cadastrar Exportador
                                            </button>
                                        </div>
                                        <!--
                                        <div class="col-md-3 form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <button type="button" class="btn btn-info" data-toggle="modal"
                                                ...
                                                <i class="fa fa-plus"></i> Cadastrar Importador
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div id="goods-part" class="content" role="tabpanel" aria-labelledby="goods-part-trigger">
                                <form id="goods-details" name="goods-details" method="post"
                                    action="ferramentas/grava_invoice_maker_goods.php">
                                    <div class="row">
                                        <input type="hidden" name="id_empresa" value="<?= $idEmpresa;?>">
...
?>
                                        ...
                                        <div class="col-md-12 form-group text-right">
                                            <a href="ferramentas/grava_invoice_maker_4.php?&idIM=<?=$idIM;?>&invoice=<?=$invoice_number;?>"
...
?>
                            ...
                            <div id="bank-part" class="content" role="tabpanel" aria-labelledby="bank-part-trigger">
                                <form id="bank-details" name="bank-details" method="post"
                                    action="ferramentas/grava_invoice_maker_bank.php">
                                    <div class="row">
                                        <input type="hidden" name="id_empresa" value="<?= $idEmpresa;?>">
    ...
    <!-- /.row -->
    <p>
        <a href="ferramentas/invoice_maker_reiniciar.php" class="btn btn-danger">
