...
header('Location: ../ferramentas.php?a=ferramentas&b=invoice_maker_editar&idIM='.$idIM.'&invoice='.$invoice.'&flag=success&tip=Produtos alterados com sucesso!&tabAtiva=2');
exit();