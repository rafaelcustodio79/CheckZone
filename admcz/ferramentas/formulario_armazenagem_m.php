            ...
            <div class="col-md-7">
                ...
                <div class="card card-info">
                    <div class="card-header with-border">
                        <h3 class="card-title">Estimativa de Armazenagem - PORTUÁRIA</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" name="cadastro-usuario-cliente" method="post"
                        action="ferramentas/calcula_armazenagem_m.php">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        Peso bruto (Kg):<br>
                                        <input type="text" id="peso_bruto" name="peso_bruto" disabled>
                                    </div>
                                    <div class="form-group">
                                        Qtde. de contêineres:<br>
                                        <input type="number" id="qtde_container" name="qtde_container" disabled>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
