                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <p>
                                    <a href="ferramentas.php?a=ferramentas&b=invoice_maker_criar" class="btn btn-info">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td class="text-center" style="width: 200px;">
                                                <a href="ferramentas.php?a=ferramentas&b=invoice_maker_gerar&idIM=<?=$resultado['id_im'];?>&invoice=<?=$resultado['invoice_number'];?>"
                                                    class="btn btn-xs btn-success"><i class="fas fa-eye"></i>
                                                    Visualizar</a>

                                                <a href="ferramentas.php?a=ferramentas&b=invoice_maker_editar&idIM=<?=$resultado['id_im'];?>&invoice=<?=$resultado['invoice_number'];?>"
                                                    class="btn btn-xs btn-warning">
                                                    <i class="fas fa-edit"></i>
                                                    Editar
                                                </a>

                                                <a href="ferramentas/invoice_maker_deletar.php?idIM=<?=$resultado['id_im'];?>&invoice=<?=$resultado['invoice_number'];?>"
