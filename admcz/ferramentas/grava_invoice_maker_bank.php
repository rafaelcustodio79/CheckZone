...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        // Executa a query
        if ($stmt->execute()) {
            header('Location: ../ferramentas.php?a=ferramentas&b=invoice_maker_gerar&flag=success&tip=Todos os passos salvos com sucesso!&invoice='.$invoice_number.'&idIM='.$idIM);
            exit();
        } else {
