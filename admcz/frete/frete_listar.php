...
$sql = "SELECT * FROM cotacao_abertura ca
		...
		WHERE ca.id_empresa = :idEmpresa AND ca.finalizada = 1
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Minhas Cotações</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Listando minhas cotações</h3>
                    </div>
                                ...
                                <table id="listCotacoes" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a
                                                    href="frete.php?a=frete&b=frete_abrir&idCotacao=<?= $resultado['id']; ?>"><i
                                                        class="fas fa-eye" title="Visualizar Cotação"></i></a>
                                                &nbsp;&nbsp;
                                                <a
                                                    href="frete.php?a=frete&b=frete_propostas&idCotacao=<?= $resultado['id']; ?>">
                                                    <i class="fas fa-solid fa-clipboard-list"
                                                        title="Visualizar Propostas"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
