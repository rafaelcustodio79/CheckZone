...
if ($_SESSION['tipo_usuario'] == 1) {
    ...
    $sql = "SELECT pro.*, pat.*, emp.*, usuario.nome AS nome_gerente
            FROM processos pro
...
// Aqui você pode utilizar o array $resultados para exibir os processos conforme necessário
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="ml-auto">
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                ...
                                <i class="fas fa-plus"></i> Cadastrar Novo Processo
                            </button>
                        </div>
                    </div>
                        ...
                        <table id="listaBanners" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a
                                            href="aduaneiro.php?a=aduaneiro&b=processos_profile&idProcesso=<?= $resultado['id_processo']; ?>&idEmpresa=<?= $resultado['id_empresa']; ?>"><i
                                                class="fas fa-eye" title="Visualizar"></i></a>

                                        <a
                                            href="aduaneiro.php?a=aduaneiro&b=processos_acoes&idProcesso=<?= $resultado['id_processo']; ?>&idEmpresa=<?= $resultado['id_empresa']; ?>"><i
                                                class="fas fa-edit" title="Editar dados do processo"></i></a>

                                        <a href="aduaneiro.php?a=aduaneiro&b=processos_deletar&id=<?= $resultado['id_empresa']; ?>"
                                            onclick="return confirm('Deseja realmente excluir o Processo Inteiro?')"><i
